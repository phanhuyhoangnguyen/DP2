...
function add_item_to_inventory()
{
    if(xHRObject)
    {
        var url = "php/add_item_to_inventory.php";
        ...
        var vars = "inv_itemID="+encodeURIComponent(id)+"&inv_quantity="+encodeURIComponent(itm_quantity)+"&inv_purchased_price="
            +encodeURIComponent(itm_purchased_price)+"&inv_selling_price="+encodeURIComponent(itm_selling_price);
